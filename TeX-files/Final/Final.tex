...
\section{Radial Basis Functions}\label{radial-basis-functions}}

\hypertarget{preliminary-code}{%
\subsection{Preliminary Code}\label{preliminary-code}}
...
\subsection{Problems 13-14}\label{problems-13-14}}

\hypertarget{answers-a-le-5-of-the-time-e-ge-75-of-the-time}{%
\subsubsection{\texorpdfstring{Answers: {[}a{]} \(\le 5\%\) of the time,
{[}e{]} \(\ge 75\%\) of the
...
\subsubsection{\texorpdfstring{Answer: {[}d{]} Both \(E_{in}\) and
\(E_{out}\) go
...
\subsubsection{\texorpdfstring{Answer: {[}c{]} Both \(E_{in}\) and
\(E_{out}\) go
...
\subsubsection{\texorpdfstring{Answer: {[}a{]} \(\le 10 \%\) of the
...
\section{Bayesian Priors}\label{bayesian-priors}}
